...
par(mfrow = c(2, 2), mar = c(5, 4, 4, 2), cex = c(0.77), lwd = c(1))
plot(pd$comptime, pd$Global_active_power, type = "l", 
             ylab="Global Active Power", xlab ="")
plot(pd$comptime, pd$Voltage, type = "l", 
...
plot(pd$comptime, pd$Global_reactive_power, type = "s", 
